...
## <a name="hosting-your-office-add-in"></a>托管你的 Office 外接程序
...
### <a name="to-create-the-files-for-a-hello-world-add-in"></a>创建 Hello World 外接程序文件
...
### <a name="running-the-add-in-locally"></a>本地运行外接程序
