...
“**Restricted**”权限是最基本级别的权限。 在清单中的“[权限](http://msdn.microsoft.com/en-us/library/c20cdf29-74b0-564c-e178-b75d148b36d1%28Office.15%29.aspx)”元素中指定“**Restricted**”以请求此权限。 如果外接程序不请求其清单中的将特定权限，在默认情况下，Outlook 会将此权限分配给邮件外接程序。
...
“**ReadItem**”权限是模型中的下一级别的权限。 在清单中的“**权限**”元素中指定“**ReadItem**”以请求此权限。
...
通过  **mailbox.makeEWSRequestAsync**，您可以访问以下 EWS 操作：
