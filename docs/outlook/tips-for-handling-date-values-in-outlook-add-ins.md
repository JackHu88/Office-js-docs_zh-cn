...
# <a name="tips-for-handling-date-values-in-outlook-add-ins"></a>处理 Outlook 外接程序中的日期值的提示
...
## <a name="date-related-features-for-outlook-add-ins"></a>Outlook 外接程序的日期相关功能
...
**API 成员**|**时区表示形式**|**Outlook 富客户端中的示例**|**Outlook Web App 或适用于设备的 OWA 中的示例**
--------------|----------------------------|-------------------------------------|-------------------------------------------------
...
### <a name="scenario-a:-displaying-item-creation-or-modified-time"></a>应用场景 A：显示项目创建时间或修改时间
...
### <a name="scenario-b:-displaying-start-and-end-dates-in-a-new-appointment-form"></a>应用场景 B：在新的约会表单中显示开始日期和结束日期
