...
<br>
![从电子表格数据生成图表的 Excel 内容应用程序](../../../images/off15appUXFig01.png)
(#从电子表格数据生成图表的-excel-内容应用程序)<br>
...
**用于插入文本的任务窗格外接程序**
<br>
![用于插入文本的任务窗格应用程序](../../../images/off15appUXFig07.png)
(#用于插入文本的任务窗格应用程序)<br>
