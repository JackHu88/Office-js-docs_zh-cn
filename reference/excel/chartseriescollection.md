# <a name="chartseriescollection-object-javascript-api-for-excel"></a>ChartSeriesCollection 对象（适用于 Excel 的 JavaScript API）
...
| 属性     | 类型   |说明| 要求集|
|:---------------|:--------|:----------|:----|
|count|int|返回集合中的系列数量。只读。|[1.1](../requirement-sets/excel-api-requirement-sets.md)|
