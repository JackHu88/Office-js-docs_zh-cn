...
| 方法           | 返回类型    |说明|
|:---------------|:--------|:----------|
|[add(name: string)](#addname-string)|[工作表](worksheet.md)|向工作簿添加新工作表。工作表将添加到现有工作表的末尾。如果您想要激活新添加的工作表，请对其调用 ".activate()。|
|[getActiveWorksheet()](#getactiveworksheet)|[工作表](worksheet.md)|获取工作簿中当前处于活动状态的工作表。|
|[getItem(key: string)](#getitemkey-string)|[工作表](worksheet.md)|使用其名称或 ID 获取 worksheet 对象。|
