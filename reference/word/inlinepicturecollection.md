# <a name="inlinepicturecollection-object-(javascript-api-for-word)"></a>InlinePictureCollection 对象（适用于 Word 的 JavaScript API）
...
| 属性     | 类型   |说明
|:---------------|:--------|:----------|
|项目|[InlinePicture[]](inlinepicture.md)|inlinePicture 对象的集合。只读。|
