# <a name="paragraphcollection-object-(javascript-api-for-word)"></a>ParagraphCollection 对象（适用于 Word 的 JavaScript API）

包含 [paragraph](paragraph.md) 对象的集合。
...
| 属性     | 类型   |说明
|:---------------|:--------|:----------|
|项目|[Paragraph[]](paragraph.md)|paragraph 对象的集合。只读。|
