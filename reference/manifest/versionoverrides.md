...
> **注意：**暂只有 Outlook 2016 支持 VersionOverrides v1.1 架构和 `VersionOverridesV1_1` 类型。
...
|  **VersionOverrides**    |  否  | 在新版架构下定义外接程序命令。有关详细信息，请参阅[实现多个版本](#implementing_multiple_versions)。 |
...
例如，若要实现 VersionOverrides v1.0 和 v1.1 架构，清单如以下示例所示。
