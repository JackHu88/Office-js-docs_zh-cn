...
|**名称**|**类型**|**说明**|**支持说明**|
|:-----|:-----|:-----|:-----|
| _prefix_|**string**|指定要为其获取命名空间的前缀。必需。||
...
在传递给 **getNamespaceAsync** 方法的回调函数中，可以使用 **AsyncResult** 对象的属性返回以下信息。



|**属性**|**用于...**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|访问包含映射到指定前缀的命名空间的 **string**。|
