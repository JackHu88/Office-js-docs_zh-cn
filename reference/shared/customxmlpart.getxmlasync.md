...
在传递给  **getXmlAsync** 方法的回调函数中，您可以使用 **AsyncResult** 对象的属性返回以下信息。



|**属性**|**用于...**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|访问一个 **string**，其中包含引用的 [CustomXmlPart](../../reference/shared/customxmlnode.getnodesasync.md) 对象的 XML。|
