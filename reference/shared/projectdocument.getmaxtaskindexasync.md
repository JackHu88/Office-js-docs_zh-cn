...
对于 **getMaxTaskIndexAsync** 方法，返回的 [AsyncResult](../../reference/shared/asyncresult.md) 对象包含下列属性：
...
|[value](../../reference/shared/asyncresult.value.md)|当前项目的任务集合中的最大索引号。|

## 备注

您可以将返回的值与 [getTaskByIndexAsync](../../reference/shared/projectdocument.gettaskbyindexasync.md) 方法一起使用以获取任务 GUID。0 索引请求表示项目摘要任务。


## 示例

以下代码示例调用 **getMaxTaskIndexAsync**，获取当前项目中的任务集合的最大索引。然后，它结合使用所返回的值和 [getTaskByIndexAsync](../../reference/shared/projectdocument.getselectedtaskasync.md) 方法，获取各个任务 GUID。
