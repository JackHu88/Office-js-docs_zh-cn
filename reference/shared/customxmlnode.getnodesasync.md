...
作为匹配相对 XPath 表达式的  **CustomXMLNode** 对象的数组获取节点。
...
|**名称**|**类型**|**说明**|**支持说明**|
|:-----|:-----|:-----|:-----|
| _xPath_|**string**|指定要获取的节点的 XPath 表达式。必需。||
...
在传递给  **getNodesAsync** 方法的回调函数中，您可以使用 **AsyncResult** 对象的属性返回以下信息。



|**属性**|**用于...**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|访问 **CustomXMLNode** 对象的 [array](../../reference/shared/customxmlnode.customxmlnode.md)，这些对象表示由传递给 _xPath_ 参数的 XPath 表达式指定的节点。|
