...
|Baseline1FixedCost|71|基准任务的所有非资源费用的固定成本。|
...
|Baseline5FixedCostAccrual|108|权责发生制，定义了基准任务累算固定成本的方式：任务开始时进行累算 = 1，任务结束时进行累算 = 2，任务进行过程中（按比例）进行累算 = 3。|
...
|ID|219|所选任务的索引。项目摘要任务后，项目中第一个任务的索引为 1。|
|Name|220|任务的名称。|
