...
# <a name="customxmlnode.namespaceuri-property"></a>CustomXmlNode.namespaceUri 属性
检索 [CustomXMLPart](../../reference/shared/customxmlpart.customxmlpart.md) 的字符串 GUID。
