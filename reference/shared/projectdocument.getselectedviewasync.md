...
|[value](../../reference/shared/asyncresult.value.md)|包含以下属性：<br/><br/><div>* **viewName** - 视图的名称，作为 [ProjectViewTypes](../../reference/shared/projectviewtypes-enumeration.md) 常量。<br/>* **viewType** - 视图的类型，作为 [ProjectViewTypes](../../reference/shared/projectviewtypes-enumeration.md) 常量的整数值。</div>|
...
(#projectviewtypes-枚举)[AsyncResult 对象](../../reference/shared/asyncresult.md)
(#asyncresult-对象)[ViewSelectionChanged 事件](../../reference/shared/projectdocument.viewselectionchanged.event.md)
#viewselectionchanged-事件[ProjectDocument 对象](../../reference/shared/projectdocument.projectdocument.md)
