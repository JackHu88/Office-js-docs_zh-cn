...
|**名称**|**类型**|**说明**|**支持说明**|
|:-----|:-----|:-----|:-----|
| _eventType_|[EventType](../../reference/shared/eventtype-enumeration.md)|指定要移除事件的类型。必需。对于 **CustomXmlPart** 对象事件，_eventType_ 参数可以指定为 **Office.EventType.DataNodeDeleted**、**Office.EventType.DataNodeInserted**、**Office.EventType.DataNodeReplaced**，也可以为这些枚举对应的文本值。||
...
| _Handler_|**string**|指定要移除的处理程序的名称。 ||
