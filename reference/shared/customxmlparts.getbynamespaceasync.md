...
在传递给  **getByNamespaceAsync** 方法的回调函数中，您可以使用 **AsyncResult** 对象的属性返回以下信息。



|**属性**|**用于...**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|访问匹配指定命名空间的 **CustomXMLPart** 对象的 [array](../../reference/shared/customxmlnode.getnodesasync.md)。|
