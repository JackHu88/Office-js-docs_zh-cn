...
|**在 [要求集](../../docs/overview/specify-office-hosts-and-api-requirements.md) 中可用**|CustomXmlParts, MatrixBindings, TableBindings, TextBindings|
|在其中进行的**最后更改**|1.1|
...
|**名称**|**类型**|**说明**|**支持说明**|
|:-----|:-----|:-----|:-----|
| _id_|**string**|指定要用于标识绑定对象的唯一名称。必需。||
...
在传递给 **getByIdAsync** 方法的回调函数中，可以使用 **AsyncResult** 对象的属性返回以下信息。



|**属性**|**用于...**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|访问 [id](../../reference/shared/binding.md) 在调用中指定的 _Binding_ 对象。|
...
|||
|:-----|:-----|
|**在要求集中可用**|CustomXmlParts, MatrixBindings, TableBindings, TextBindings|
