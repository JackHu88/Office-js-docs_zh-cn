...
# <a name="customxmlnode.nodetype-property"></a>CustomXmlNode.nodeType 属性
获取 [CustomXMLNode](../../reference/shared/customxmlnode.customxmlnode.md) 的类型。
...
指定节点类型的 [CustomXMLNodeType](../../reference/shared/customxmlnodetype-enumeration.md)。
